...
# current working directory called "cruises-to-upload.txt". Cruises can be
# commented out with an initial "#". One cruise per line. Also in the current
# working directory there should be corresponding cruise folders containing one
# zip file per day-of-year folder, each of which expands to a day-of-year folder
# containing uncompressed EVT files.
#
...
with open("cruises-to-upload.txt", mode="r", encoding="utf8") as fh:
